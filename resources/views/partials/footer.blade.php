<footer id="contact-section" class="bg-opes-darker mt-16 md:mt-32 border-t border-white/5 pt-12 md:pt-24 pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <!-- Solution Brochures Section -->
        <div class="mt-16 md:mt-24 border-t border-white/5 pt-12">
            <div class="text-center md:text-left mb-6">
                <h3 class="text-lg md:text-xl font-bold text-opes-text-main tracking-wide">Enterprise Solution Brochures</h3>
                <p class="text-xs md:text-sm text-opes-text-gray/70 mt-1">Download operational overviews and econsystem services information.</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- CRM & ERP Solutions (Cyan Style) -->
                <a href="{{ Vite::asset('resources/brochures/Custom-CRM-&-ERP-Solutions.pdf') }}" target="_blank" class="flex items-center gap-4 p-4 bg-opes-cyan/5 hover:bg-opes-cyan/10 text-opes-cyan border border-opes-cyan/20 hover:border-opes-cyan/40 rounded-xl transition-all duration-300 group">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-opes-cyan/10 flex items-center justify-center text-lg">
                        <i class="fa-solid fa-file-pdf"></i>
                    </div>
                    <div class="min-w-0">
                        <p class="text-xs text-opes-text-gray uppercase tracking-wider font-bold">Capabilities Blueprint</p>
                        <p class="text-sm font-semibold text-opes-text-main truncate group-hover:text-opes-cyan transition-colors mt-0.5">Custom CRM & ERP Solutions</p>
                    </div>
                </a>

                <!-- Customer Engagement & Bulk SMS (Orange Style) -->
                <a href="{{ Vite::asset('resources/brochures/Customer-Engagement-·-Bulk-SMS,-Email-&-AI-Chatbot.pdf') }}" target="_blank" class="flex items-center gap-4 p-4 bg-opes-orange/5 hover:bg-opes-orange/10 text-opes-orange border border-opes-orange/20 hover:border-opes-orange/40 rounded-xl transition-all duration-300 group">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-opes-orange/10 flex items-center justify-center text-lg">
                        <i class="fa-solid fa-file-pdf"></i>
                    </div>
                    <div class="min-w-0">
                        <p class="text-xs text-opes-text-gray uppercase tracking-wider font-bold">Communications Platform</p>
                        <p class="text-sm font-semibold text-opes-text-main truncate group-hover:text-opes-orange transition-colors mt-0.5">Customer Engagement Matrix</p>
                    </div>
                </a>

                <!-- Telematics & Fleet Management (Emerald Style) -->
                <a href="{{ Vite::asset('resources/brochures/Telematics-&-Fleet-Management-Services.pdf') }}" target="_blank" class="flex items-center gap-4 p-4 bg-emerald-500/5 hover:bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:border-emerald-500/40 rounded-xl sm:col-span-2 lg:col-span-1 transition-all duration-300 group">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center text-lg">
                        <i class="fa-solid fa-file-pdf"></i>
                    </div>
                    <div class="min-w-0">
                        <p class="text-xs text-opes-text-gray uppercase tracking-wider font-bold">Intelligence Infrastructure</p>
                        <p class="text-sm font-semibold text-opes-text-main truncate group-hover:text-emerald-400 transition-colors mt-0.5">Telematics & Fleet Intelligence</p>
                    </div>
                </a>
            </div>
        </div>
            ...
            <div class="lg:col-span-5 space-y-6 md:space-y-8">
                <div class="bg-white/5 p-6 md:p-8 rounded-xl flex items-start gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-lg md:text-xl font-bold text-opes-text-main tracking-wide"><a href="tel:+255693099999">+255 693 099 999</a></p>
                        <p class="text-lg md:text-xl font-bold text-opes-text-main tracking-wide"><a href="tel:+255222774966">+255 222 774 966</a></p>
                    </div>
                </div>
                ...
                <div class="bg-white/5 p-6 md:p-8 rounded-xl flex items-start gap-4 md:gap-6 overflow-hidden">
                    ...
                    <div class="min-w-0 break-all sm:break-normal">
                        ...
                        <p class="text-lg md:text-xl font-bold text-opes-text-main tracking-wide"><a href="mailto:info@opes.co.tz">info@opes.co.tz</a></p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <!-- WhatsApp -->
                    <a href="https://wa.me/255798888997" class="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-opesRed hover:text-white transition-all duration-300 border border-white/10 group">
