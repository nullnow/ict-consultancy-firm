...
@section('content')
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <section class="relative bg-cover bg-center bg-no-repeat py-20 md:py-32 mb-20 md:h-20" style="background-image: url('{{ Vite::asset("resources/images/banners/opes-services.png") }}');">
